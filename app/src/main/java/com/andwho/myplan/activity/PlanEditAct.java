 ...
 * 编辑计划 ouyyx
 */
public class PlanEditAct extends BaseAct implements OnClickListener {

	private static final String TAG = PlanEditAct.class.getSimpleName();
	...
	private void save() {
		...
		if (isEditModel) {
			...
			plan.updatetime = DateUtil.getCurDateYYYYMMDDHHSS();

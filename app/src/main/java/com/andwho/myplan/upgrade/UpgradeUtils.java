            ...
            query.findObjects(ctx, new FindListener<CheckUpdate>() {
                ...
                public void onSuccess(List<CheckUpdate> arg0) {
                    // TODO Auto-generated method stub
                     ...
                     Log.e(TAG, "@@...smpp...CheckUpdate size = " + arg0);
                    ...
                    if (arg0 != null && arg0.size() > 0) {
                        ...
                        // versionInfo.isForced = "0";
						 Log.e(TAG, "@@...smpp...CheckUpdate currentVersion = "
						 + versionInfo.currentVersion);
						 Log.e(TAG, "@@...smpp...CheckUpdate newVersion = "
						 + versionInfo.newVersion);
						 Log.e(TAG,
						 "@@...smpp...CheckUpdate availableVersion = "
						 + versionInfo.availableVersion);
						 Log.e(TAG, "@@...smpp...CheckUpdate description = "
						 + versionInfo.description);
						 Log.e(TAG, "@@...smpp...CheckUpdate isForced = "
						 + versionInfo.isForced);
						 Log.e(TAG, "@@...smpp...CheckUpdate path = "
						 + versionInfo.path);
						 Log.e(TAG, "@@...smpp...CheckUpdate packageSize = "
